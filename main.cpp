...
//    }
    ...
    GeoDatabase geodb;
    geodb.load("/Users/hunterkang/Desktop/CS32/Proj4_TourGenerator/Proj4_TourGenerator/tester.txt");
...
//    }
    ...
    GeoPoint AckermanUnion("34.0705851", "-118.4439429");
    GeoPoint JohnWoodenCenter("34.0720093", "-118.4458886");

    Router router(geodb);
//    std::vector<GeoPoint> pts = router.route(AckermanUnion, JohnWoodenCenter);
//
//    for (size_t i = 0; i < pts.size(); i++)
//    {
//        std::cout << pts[i].to_string() << std::endl;
//    }
    ...
    Stops stops;
    stops.load("/Users/hunterkang/Desktop/CS32/Proj4_TourGenerator/Proj4_TourGenerator/Stops.txt");
